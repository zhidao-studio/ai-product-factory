...
/**
 * 产品端应用业务对象 client_application。
 *
 * @author Lion Li
 */
@Data
@AutoMapper(target = ClientApplication.class, reverseConvertGenerate = false)
public class ClientApplicationBo implements Serializable {
