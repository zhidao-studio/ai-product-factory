...
insert into sys_menu values(1761400000000000007, '产品运营', 0, 6, 'client', null, '', 'N', 'Y', 'M', '0', '0', '', 'peoples', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '产品运营目录');
...
insert into sys_menu values(1761400000000000134, '应用用户', 1761400000000000007, 1, 'user', 'client/user/index', '', 'N', 'Y', 'C', '0', '0', 'client:user:list', 'user', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '应用用户管理菜单');
insert into sys_menu values(1761400000000000135, '接入应用', 1761400000000000007, 2, 'application', 'client/application/index', '', 'N', 'Y', 'C', '0', '0', 'client:application:list', 'international', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '接入应用管理菜单');
...
-- 产品运营按钮
insert into sys_menu values(1761400000000001630, '应用用户查询', 1761400000000000134, 1, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:query', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001631, '应用用户新增', 1761400000000000134, 2, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:add', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001632, '应用用户修改', 1761400000000000134, 3, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:edit', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001633, '应用用户删除', 1761400000000000134, 4, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:remove', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001634, '应用用户导出', 1761400000000000134, 5, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:export', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001635, '应用用户重置密码', 1761400000000000134, 6, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:user:resetPwd', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001640, '接入应用查询', 1761400000000000135, 1, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:application:query', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001641, '接入应用新增', 1761400000000000135, 2, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:application:add', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001642, '接入应用修改', 1761400000000000135, 3, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:application:edit', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
insert into sys_menu values(1761400000000001644, '接入应用导出', 1761400000000000135, 5, '#', '', '', 'N', 'Y', 'F', '0', '0', 'client:application:export', '#', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '');
-- 测试菜单
...
insert into sys_dict_data values(1761600000000000060, 0, '手机号密码认证', 'phonePassword', 'sys_grant_type', '', 'default', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, '手机号密码认证');
...
insert into sys_dict_data values(1761600000000000061, 0, 'H5', 'h5', 'sys_device_type', '', 'default', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, 'H5');
insert into sys_dict_data values(1761600000000000062, 0, 'App', 'app', 'sys_device_type', '', 'default', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, 'App');
insert into sys_dict_data values(1761600000000000063, 0, '微信小程序', 'miniapp', 'sys_device_type', '', 'default', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, '微信小程序');
insert into sys_dict_data values(1761600000000000064, 0, 'HarmonyOS', 'harmony', 'sys_device_type', '', 'default', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, 'HarmonyOS');
...
comment on column app_user.email              is '用户邮箱';
comment on column app_user.phone_number       is '手机号码';
comment on column app_user.gender             is '用户性别（0男 1女 2未知）';
...
create unique index uk_app_client_client_id ON app_client (client_id);
create unique index uk_app_client_client_key ON app_client (client_key);

comment on table app_client                         is '接入应用授权表';
comment on column app_client.id                     is '主键';
comment on column app_client.client_id              is '客户端id';
comment on column app_client.client_key             is '客户端key';
comment on column app_client.client_secret          is '客户端秘钥';
comment on column app_client.grant_type             is '授权类型';
comment on column app_client.device_type            is '设备类型';
comment on column app_client.access_path            is '允许访问路径';
...
create unique index uk_app_user_identity_auth_id ON app_user_identity (auth_id);

comment on table app_user_identity                         is '应用用户第三方身份表';
comment on column app_user_identity.id                     is '主键';
comment on column app_user_identity.user_id                is '应用用户ID';
comment on column app_user_identity.auth_id                is '平台+平台唯一id';
comment on column app_user_identity.source                 is '用户来源';
comment on column app_user_identity.open_id                is '平台编号唯一id';
comment on column app_user_identity.user_name              is '登录账号';
comment on column app_user_identity.nick_name              is '用户昵称';
comment on column app_user_identity.email                  is '用户邮箱';
comment on column app_user_identity.avatar                 is '头像地址';
comment on column app_user_identity.access_token           is '用户的授权令牌';
comment on column app_user_identity.expire_in              is '用户的授权令牌的有效期，部分平台可能没有';
comment on column app_user_identity.refresh_token          is '刷新令牌，部分平台可能没有';
comment on column app_user_identity.access_code            is '平台的授权信息，部分平台可能没有';
comment on column app_user_identity.union_id               is '用户的 unionid';
comment on column app_user_identity.scope                  is '授予的权限，部分平台可能没有';
comment on column app_user_identity.token_type             is '个别平台的授权信息，部分平台可能没有';
comment on column app_user_identity.id_token               is 'id token，部分平台可能没有';
comment on column app_user_identity.mac_algorithm          is '小米平台用户的附带属性，部分平台可能没有';
comment on column app_user_identity.mac_key                is '小米平台用户的附带属性，部分平台可能没有';
